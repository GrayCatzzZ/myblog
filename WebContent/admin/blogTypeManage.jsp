...
<script type="text/javascript">
    ...
    function openBlogTypeAddDialog() {
        ...
        //将url设置为添加
        url = "${pageContext.request.contextPath}/admin/blogTypeSave";
    }
    /**
     * 打开修改博客类别信息对话框
     */
    function openBlogTypeModifyDialog() {
        ...
        url = "${pageContext.request.contextPath}/admin/blogTypeSave?id=" + row.cat_id;
    }
    /**
     * 添加或者修改博客类别
     */
    ...
    function deleteBlogType() {
        ...
        for(var i = 0; i < selectedRows.length; i++) {
        	alert(selectedRows[i].cat_id);
            idsStr.push(selectedRows[i].cat_id);
        }
        //将数组安装,连接成字符串
        ...
        $.messager.confirm("系统提示", "<font color=red>您确定要删除选中的"+selectedRows.length+"条数据么？</font>", function(r) {
            if(r) {
                $.post("${pageContext.request.contextPath}/admin/blogTypeDelete",
...
<table id="dg" title="博客类别管理" class="easyui-datagrid" fitColumns="true" pagination="true"
       url="${pageContext.request.contextPath}/admin/listBlogType" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="cat_id" width="20" align="center">编号</th>
        <th field="cat_name" width="100" align="center">博客分类名称</th>
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>博客类别名称</td>
                <td>
                    <input type="text" id="typeName" name="cat_name" class="easyui-validatebox" required="true">
                </td>
            </tr>
        </table>
    </form>
