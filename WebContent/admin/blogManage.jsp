...
<script type="text/javascript">
	...
	function deleteBlog() {
		...
		for(var i = 0; i < selectedRows.length; i++) {
			idsStr.push(selectedRows[i].art_id);
		}
		//将数组安装,连接成字符串
	...
	function openBlogModifyTab() {
		...
		window.parent.openTab("修改博客","modifyBlogURL?id=" + row.art_id, "icon-writeblog");
	}
    /**
	 * 重新载入数据
     */
...
<table id="dg" title="博客管理" class="easyui-datagrid" fitColumns="true" pagination="true"
	url="${pageContext.request.contextPath}/admin/blogManage" toolbar="#tb">
	<thead>
		<tr>
			<th field="cb" checkbox="true" align="center"></th>
			<th field="art_id" width="20" align="center">编号</th>
			<th field="title" width="200" formatter="formatTitle">标题</th>
			<th field="art_time" width="100" align="center">发布日期</th> 
			<th field="cat_name" width="100" align="center" >博客类型</th>
		</tr>
	</thead>
</table>
<div id="tb">
